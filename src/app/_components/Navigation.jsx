...
//   const navItems = [
//     { key: 'home', label: 'الرئيسية', icon: HomeIcon, path: '/' },
//     { key: 'menu', label: 'القائمة', icon: Utensils, path: '/menu' },
//     { key: 'kitchen', label: 'المطبخ', icon: ChefHat, path: '/kitchen' },
//     { key: 'about', label: 'عن المطعم', icon: Users, path: '/about' },
//     { key: 'reviews', label: 'التقييمات', icon: MessageSquare, path: '/reviews' },
//     { key: 'admin', label: 'الإدارة', icon: Users, path: '/admin' }
//   ];
